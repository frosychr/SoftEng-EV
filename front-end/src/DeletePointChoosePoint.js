...
import { displaypoints, deletepointt } from './api';
import './App.css';
import { UserContext } from './UserContext';
import { Header, Footer } from './HeaderFooter';
import { Redirect } from 'react-router';

class DeletePointChoosePoint extends React.Component {
        ...
        if (this.state.location_id !== "redirect") {
            return (
                <div className="loginformdiv">
                    ...
                    <div className="row">
                        <h2>Click the station you want to delete</h2>
...
export default DeletePointChoosePoint;
