...
class FailManageLocation extends React.Component {
        ...
        return (
            ...
            <div className="loginformdiv">
                ...
                <div className="row3">
                    ...
                    <button className="button28" type="submit" onClick={() => { this.props.history.push('/'); }} style={{ width: '180px', height: '42px' }}>Try Again</button>
                </div>
...
export default FailManageLocation;