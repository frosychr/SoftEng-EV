...
class TestSessionPerPointView(APITestCase):
    ...
    '''
    '''
    evcharge/api/SessionsPerStation/<int:station_id>/<str:start_date>/<str:end_date>/
    '''
    ...
    def setUp(self):
        ...
        self.view = SessionPerStationView.as_view()
    ...
    def test_call_as_admin(self):
        ...
        start_date = '20101010'
        end_date = '20201213'
        kwargs = {'station_id': station_id, 'start_date': start_date, 'end_date': end_date}
        url = reverse('session_per_station', kwargs = kwargs)
    ...
    def test_call_with_invalid_station(self):
