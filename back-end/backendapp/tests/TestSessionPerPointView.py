...
class TestSessionPerPointView(APITestCase):
    ...
    '''
    '''
    Url: evcharge/api/SessionsPerPoint/<int:point_id>/<str:start_date>/<str:end_date>/
    '''
    ...
    def setUp(self):
        ...
        self.provider = EnergyProviders.objects.create(id = self.user_provider)
        '''Create Station'''
        ...
        '''Create Charge'''
        self.charge = Charge.objects.create(vehicle_carowner_id = self.vehicle, station_id_id = self.point, started_on = datetime(2019, 12, 12), finished_on = datetime(2019, 12, 12), energy_amount = 30)

        self.loginview = LoginView.as_view()
        self.view = SessionPerPointView.as_view()
    ...
    def test_call_as_admin(self):
        ...
        start_date = '20101010'
        end_date = '20201213'
        kwargs = {'point_id': point_id, 'start_date': start_date, 'end_date': end_date}
        url = reverse('session_per_point', kwargs = kwargs)
    ...
    def test_call_with_invalid_point(self):
